...
function lookup() {
	document.getElementById("caption").innerHTML = "<h3 class='caption'>This is my good side.</h3>";
	document.getElementById("qwe").src = "images/darth-vader-look-up_b.jpg";
}

function kitten() {
	document.getElementById("caption").innerHTML = "<h3 class='caption'>When I think about all the cats without a home, I cry.</h3>";
	document.getElementById("qwe").src = "images/darth-vader-kitten_b.jpg";
}

function atwork () {
	document.getElementById("caption").innerHTML = "<h3 class='caption'>My boss and I at a work convention.</h3>";
	document.getElementById("qwe").src = "images/darth-vader-atwork_b.jpg";
}

function proof() {
	document.getElementById("caption").innerHTML = "<h3 class='caption'>I've always loved this shot of me.</h3>";
	document.getElementById("qwe").src = "images/darth-vader-proof_b.jpg";
}

function lightsaber() {
	document.getElementById("caption").innerHTML = "<h3 class='caption'>I'm a licensed Jedi master. I hope to open my own studio one day to teach others.</h3>";
	document.getElementById("qwe").src = "images/darth-vader-lightsaber_b.jpg";
}

function thinner() {
	document.getElementById("caption").innerHTML = "<h3 class='caption'>A shot of me from high school.</h3>";
	document.getElementById("qwe").src = "images/darth-vader-thinner_b.jpg";
}

function dog() {
	document.getElementById("caption").innerHTML = "<h3 class='caption'>I am tolerant of dogs.</h3>";
	document.getElementById("qwe").src = "images/darth-vader-dog_b.jpg";
}

function hellokitty() {
	document.getElementById("caption").innerHTML = "<h3 class='caption'>I love me in white.</h3>";
	document.getElementById("qwe").src = "images/darth-vader-hello-kitty_b.jpg";
}

function tiefighter() {
	document.getElementById("caption").innerHTML = "<h3 class='caption'>My ride.</h3>";
	document.getElementById("qwe").src = "images/darth-vaders-tie-fighter_b.jpg";
}

function deathstar() {
	document.getElementById("caption").innerHTML = "<h3 class='caption'>I believe in owning property. Here's a planet I owned until the 'Great Bang'.</h3>";
	document.getElementById("qwe").src = "images/death-star_b.jpg";
}

function daughter() {
	document.getElementById("caption").innerHTML = "<h3 class='caption'>My daughter. We really don't see eye to eye. She doesn't understand my lifestyle.</h3>";
	document.getElementById("qwe").src = "images/daughter_b.jpg";
}

function son() {
	document.getElementById("caption").innerHTML = "<h3 class='caption'>My son. I'm confident he will take over the family business.</h3>";
